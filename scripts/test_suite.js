...
async function main() {
  ...
  {
    await (await fac.configMint(await capT.getAddress(), false, 600, 1000, E("0.001"), E("0.06"), E("0"), E("0.1"), 3600)).wait();
  ...
  }
  {
    ...
    await (await fac.configMint(await direct.getAddress(), false, 600, 1000, E("0.001"), E("0.05"), E("0"), E("0.1"), 3600)).wait();
  ...
  }
  {
    ...
    await (await fac.configMint(await t2.getAddress(), false, 600, 1000, E("0.001"), E("0.1"), E("0"), E("0.1"), 3600)).wait();
  ...
  // ---------- 退款（含撤池路径） ----------
  {
    ...
    await (await fac.configMint(await t3.getAddress(), false, 600, 1000, E("0.001"), E("0.05"), E("0"), E("0.1"), 3600)).wait();
  ...
  // ---------- ERC20 底池 mint 入池 ----------
  {
    ...
    await (await fac.configMint(await t4.getAddress(), false, 600, 1000, E("0.001"), E("0.05"), E("0"), E("0.1"), 3600)).wait();
  ...
  await (await fac.configMint(ftAddr, false, 600, 1000, E("0.001"), E("0.1"), E("0"), E("0.1"), 3600)).wait();
  ...
  async function freshDivToken(name) {
    ...
    await (await fac.configMint(addr, false, 600, 1000, E("0.001"), E("0.1"), E("0"), E("0.1"), 3600)).wait();
  ...
  // ---------- Mint 规则校验 ----------
  {
    ...
    const r1 = await expectRevert(fac.configMint(a5, false, 0, 1000, E("0.001"), E("0.05"), E("0"), E("0.1"), 3600));
    const r2 = await expectRevert(fac.configMint(a5, false, 1001, 1000, E("0.001"), E("0.05"), E("0"), E("0.1"), 3600));
    const r2b = await expectRevert(fac.configMint(a5, false, 599, 1000, E("0.001"), E("0.05"), E("0"), E("0.1"), 3600));
    const r3 = await expectRevert(fac.configMint(a5, false, 600, 1000, E("0.00000000001"), E("0.05"), E("0"), E("0.1"), 3600));
    const r4 = await expectRevert(fac.configMint(a5, false, 600, 1000, E("0.001"), E("0.05"), E("0"), E("0.09"), 3600));
    r1 && r2 && r2b && r3 && r4 ? ok("Mint 参数校验(poolPct<600 / poolPct>1000 / minMint / 门槛≥0.1)") : bad("Mint 校验", `${r1}${r2}${r2b}${r3}${r4}`);
    await (await fac.configMint(a5, true, 600, 1000, E("0.001"), E("0.05"), E("0"), E("0.1"), 3600)).wait();
  ...
  {
    for (const pp of [600, 800, 900, 1000]) {
  ...
  }
  {
    ...
    await (await fac.configMint(t33a, false, 600, 1000, E("0.001"), E("0.04"), E("0"), E("0.1"), 3600)).wait();
  ...
  }
  {
    ...
    await (await fac.configMint(tsa, false, 600, 1000, E("0.001"), E("0.01"), E("0"), E("0.1"), 3600)).wait();
  ...
  // ---------- 确定性发射（CREATE2 + commit-reveal + bbbb 靓号） ----------
  {
    ...
    if (!salt) { bad("确定性发射", "未找到 bbbb 靓号 salt"); }
      ...
      const cfgOk = await (await fac.configMint(ev2.args.token, false, 600, 1000, E("0.001"), E("0.1"), E("0"), E("0.1"), 3600)).wait();
